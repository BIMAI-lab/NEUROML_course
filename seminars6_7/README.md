...
Also all artifacts (preprocessed data etc.) obtained during two parts of the seminar are uploaded [here](https://disk.yandex.ru/d/V5N05i337wUw_g). In case of any problem with notebook execution you can simply take it and use. The procedure of using this data is the same as for dataset download part.
